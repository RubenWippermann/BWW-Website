...
| **HTTPS-Enforce / Apex-Zert** | 🟢 **GESCHLOSSEN (04.08. abends verifiziert):** Enforce HTTPS an, `http://www` + `http://apex` → 301 https://www, HSTS aktiv, Apex-Zert `CN=www…` gültig bis 02.11.2026. **These „braucht alle 4 A-Records / Apex unrettbar" WIDERLEGT** — Apex hat weiter nur 1/4 A-Records und ist trotzdem grün; es genügte der Enforce-Haken. | erledigt | ✅ |
