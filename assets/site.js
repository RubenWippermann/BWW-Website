...
document.addEventListener('DOMContentLoaded',()=>{if(document.getElementById('calcResult'))calculateDguv();initCompliance();renderGame();renderNotruf();if(document.querySelector('.filter-bar'))filterKnowledge('all');});
